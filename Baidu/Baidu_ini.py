...
Baidu_Upload['Upload_GroupId'] = "test_add"  # 要上传图片所在的组，没有则新创建
# 添加学号
config["Baidu_AddID"] = {}
Baidu_AddID = config["Baidu_AddID"]
Baidu_AddID['AddId_Id_Path'] = "E:\\Build_Face_DB\\stu.txt"  # 给图片加学号，学号路径
Baidu_AddID['AddId_Imgs_Path'] = "E:\\Build_Face_DB\\add_students_face\\"  # 给图片加学号，图片路径
# 人脸库删除
config["Baidu_Delete"] = {}
Baidu_Delete = config["Baidu_Delete"]
Baidu_Delete['Delete_Stuid_Path'] = "E:\\Build_Face_DB\\delete_students_face\\all_stu_id.txt"  # 批量删除学号路径
Baidu_Delete['Delete_GroupId'] = "test_add"  # 删除人脸库组名
# 人脸检测
config["Baidu_Detect"] = {}
...
Baidu_Detect["Search_Groupid"] = "test_add"

# 给图片分组
config["Move_Imgs"] = {}
Move_Imgs = config["Move_Imgs"]
Move_Imgs["Move_Path"] = "E:\\study\\all_pic\\"
# 保存配置文件
